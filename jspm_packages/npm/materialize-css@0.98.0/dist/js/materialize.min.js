        ...
        if (a) {
          ...
          for (var f = 0; c > f; f++)
            if (t.State.calls[f]) {
              ...
              for (var r = Math.min((b - n) / j.duration, 1),
                  s = 0,
                  u = i.length; u > s; s++) {
                var w = i[s],
                    y = w.element;
  ...
  Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, function(a) {
    ...
    a(document).ready(function() {
      ...
      a(f).each(function() {
        ...
        for (var b = a(this).closest(".file-field"),
    ...
    Materialize.scrollFire = function(a) {
      var c = function() {
        for (var b = window.pageYOffset + window.innerHeight,
            c = 0; c < a.length; c++) {
          var d = a[c],
              e = d.selector,
              f = d.offset,
    ...
    "function" == typeof define && define.amd ? define(["picker", "jquery"], a) : "object" == typeof exports ? module.exports = a(require('./picker'), require('jquery')) : a(Picker, jQuery);
  }(function(a, b) {
    function c(a, b) {
      var c = this,
          d = a.$node[0],
        ...
        return b = a.extend(c, b), this.each(function() {
          ...
          function m(a) {
            var b,
                ...
                f;
            if (t)
              if (b = d(a), y = e(a), c = w - b, f = Math.abs(x - y), f < 30 && !H)
                (c > 2 || c < -2) && (G = !0, w = b, g(r + c));
              else {
                if (G)
          ...
          function n(a) {
            if (t)
              return t = !1, clearInterval(F), A = r, (B > 10 || B < -10) && (z = .9 * B, A = r + z), A = Math.round(A / u) * u, b.noWrap && (A >= u * (v - 1) ? A = u * (v - 1) : A < 0 && (A = 0)), z = A - r, E = Date.now(), requestAnimationFrame(i), G && (a.preventDefault(), a.stopPropagation()), !1;
          }
          var o,
              p,
              q,
